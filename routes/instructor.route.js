...
import { addCourseModule, addVideo, createCourseDraft, deleteDraftedCourse, deleteModule, deleteVideo, getAllCourses, getCourseAnalytics, getSignature, instructorVerification, reorderModules, reorderVideos, submitCourseReview, updateCourse, viewInstructorVerificationRequests} from "../controller/instructorController.js"
...
instructorRoute.get("/analytics/course/:courseId",isInstructorVerified,getCourseAnalytics)
instructorRoute.post("/course/:draftCourseId/add-module",isInstructorVerified,addCourseModule)
...
instructorRoute.delete("/delete-course/:courseId",isInstructorVerified,deleteDraftedCourse)
instructorRoute.post("/add-video/course/:courseId/module/:moduleId",isInstructorVerified,addVideo)
